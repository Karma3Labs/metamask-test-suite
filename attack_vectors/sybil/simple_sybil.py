...
"""
def create_sybil_cluster(pretrusted_peers: list, sybil_root_peer_id: str, sybil_cluster_size: int):
...
def execute_sybil_endorse(pretrusted_peers: list, sybil_root_peer_id: str, sybil_cluster_size: int, bad_snap_id: str):
    ...
    # 3.1: sybil cluster endorses malicious snaps
...
def run_execute_simple_sybil_endorse(sybil_cluster_size):
    ...
    return f"compute_inputs/simple_sybil/simple_sybil_{sybil_cluster_size}_sybil_peers.csv", initialise_network_attestations + execute_sybil_endorse_attestations
